...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull FrameLayout flFragment, @NonNull RelativeLayout loadingSpinner,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout loadingSpinner = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, drawerLayout, flFragment,
          loadingSpinner, navigationView, toolbar);
    }
